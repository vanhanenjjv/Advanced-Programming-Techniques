...
Student::Student(std::string name, std::string student_number) {
  ...
  std::cout << "Student - Constructor with parameters\n";
}
...
void Student::set_name(std::string name) { this->name_ = name; }

std::string Student::student_number() { return this->student_number_; }
void Student::set_student_number(std::string student_number) { this->student_number_ = student_number; }

int Student::credits() { return this->credits_; }
void Student::set_credits(int credits) { this->credits_ = credits; }
